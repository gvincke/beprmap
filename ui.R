...
shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    h5(HTML('Lieux de l&acirc;chers')),
    selectInput("selection", strong(HTML("Classification :")),
                list(" "="unselected",
                     ...
                     "AWC : Tous"="awc",
                     "Itinéraire : Le Centre Andenne" = "centand", 
                     "Itinéraire : L'Avenir de Forville"="af",
...
#                 selected="unselected",
#                 selectize=FALSE),br(),
    selectInput("towns",strong(HTML("Lieux individuels :")),"",selectize=FALSE,multiple=TRUE),br(),
...
#                 )),
    ...
    checkboxInput("labels", label = "Afficher le nom des lieux de lâchers", value = TRUE),br(),
...
radioButtons("round", HTML("Arrondir au"),
    ...
    HTML('<hr style="border:1px solid #ccc;"/>'),
    h5(HTML("Afficher")),
    checkboxInput("zones2014", label = "Zones pour le demi-fond et le fond 2014", value = FALSE),br(),
    checkboxInput("zones2015", label = "Zones pour le demi-fond et le fond 2015", value = FALSE),br(),
